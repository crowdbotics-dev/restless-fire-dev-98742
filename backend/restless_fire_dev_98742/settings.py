"""
Django settings for restless_fire_dev_98742 project.
...
ROOT_URLCONF = 'restless_fire_dev_98742.urls'
...
WSGI_APPLICATION = 'restless_fire_dev_98742.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_fire_dev_98742 API",
    "DESCRIPTION": "API documentation for restless_fire_dev_98742 App",
    "VERSION": "v1",
}
